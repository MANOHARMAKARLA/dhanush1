...
<html>
    ...
    <body style="background:black;color:white;">
        ...
        <div class="row">
            ...
            <div class="col-md-1" style="line-height:30px;font-size:1em;">
                <a href="participantlist.jsp" style="color:pink;">Click Here</a>
            </div>
            <div class="col-md-4">&nbsp;</div>
        </div><br>
        <div class="row">
            <div class="col-md-4">&nbsp;</div>
            <div class="col-md-3" style="line-height:30px;font-size:2em;">
                <font face="Satisfy">Update Winners</font>
            </div>
            <div class="col-md-1" style="line-height:30px;font-size:1em;">
                <a href="winner_list.jsp" style="color:pink;">Click Here</a>
            </div>
            <div class="col-md-4">&nbsp;</div>
        </div><br>
        <div class="row">
        ...
        <%
            ...
            {
                Statement st = con.createStatement();
                ResultSet res = st.executeQuery("select cashier,count(event) from dhanush.registerevents group by cashier order by count(event) desc");
                i=1;
                sum=0;
                while(res.next())
                {

...
<html>
    ...
    <body style="background:black;color:white;">
        ...
        <div class="row">
            <div class="col-md-4">&nbsp;</div>
            <div class="col-md-3" style="line-height:30px;font-size:2em;">
                <font face="Satisfy">View Students Events</font>
            </div>
            <div class="col-md-1" style="line-height:30px;font-size:1em;">
                <a href="displayevents.jsp" style="color:pink;">Click Here</a>
            </div>
            <div class="col-md-4">&nbsp;</div>
        </div><br>
        <div class="row">
            <div class="col-md-4">&nbsp;</div>
            <div class="col-md-3" style="line-height:30px;font-size:2em;">
                <font face="Satisfy">Participation View</font>
            </div>
            <div class="col-md-1" style="line-height:30px;font-size:1em;">
                <a href="participantlist1.jsp" style="color:pink;">Click Here</a>
            </div>
            <div class="col-md-4">&nbsp;</div>
        </div><br>
        <div class="row">
            <div class="col-md-4">&nbsp;</div>
            <div class="col-md-3" style="line-height:30px;font-size:2em;">
                <font face="Satisfy">Login Wise Amount</font>
            </div>
            <div class="col-md-1" style="line-height:30px;font-size:1em;">
                <a href="cost_reg.jsp" style="color:pink;">Click Here</a>
            </div>
            <div class="col-md-4">&nbsp;</div>
        </div><br>
        <div class="row">
            <div class="col-md-4">&nbsp;</div>
            <div class="col-md-3" style="line-height:30px;font-size:2em;">
                <font face="Satisfy">View Winners</font>
            </div>
            <div class="col-md-1" style="line-height:30px;font-size:1em;">
                <a href="event_winners.jsp" style="color:pink;">Click Here</a>
            </div>
            <div class="col-md-4">&nbsp;</div>
        </div><br>
		<div class="row">
            <div class="col-md-4">&nbsp;</div>
            <div class="col-md-3" style="line-height:30px;font-size:2em;">
                <font face="Satisfy">Overall Report</font>
            </div>
            <div class="col-md-1" style="line-height:30px;font-size:1em;">
                <a href="display_events.jsp" style="color:pink;">Click Here</a>
            </div>
            <div class="col-md-4">&nbsp;</div>
        </div><br>
    </body>
    <br><br>
        ...
        <%
            ...
            {
                Statement st = con.createStatement();
                ResultSet res = st.executeQuery("select id,cashier,count(event) from dhanush.registerevents group by id,cashier order by cashier,count(event) desc");
                i=1;
                sum=0;
				int amount1=0;
                while(res.next())
                {
					...
					amount1 = ((x/6)*150) + ((x%6)*50);
                %>
                <tr>
                    <td><%=i %></td>
                    <td align="left"><%=res.getString("cashier") %> (<%=res.getString("id")%>)</td>
                    <td><%=x %></td>
